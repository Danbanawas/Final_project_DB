...
export type { VotingSystem } from "./contracts/Votingsys.sol/VotingSystem";
export { VotingSystem__factory } from "./factories/contracts/Votingsys.sol/VotingSystem__factory";
